...
export class Ebay_FR extends Component {
    constructor() {
        super()
        this.state = {
            abc: {},
    ...
    async componentDidMount() {
        ...
        var finalObj = {};
        var allKeyId = {}
        await fetch('https://raw.githubusercontent.com/erashish455/text/main/Ebay_FR.txt').then(response => response.text())
            .then(data => {
                let maxLength = 0
                let txt = data
                temp = txt.split("\n");
